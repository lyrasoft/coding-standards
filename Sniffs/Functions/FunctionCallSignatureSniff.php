<?php
/**
 * Windwalker_Sniffs_Functions_FunctionCallSignatureSniff.
 *
 * PHP version 5
 *
 * @category  PHP
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Windwalker_Sniffs_Functions_FunctionCallSignatureSniff implements PHP_CodeSniffer_Sniff
{
...
//                    $phpcsFile->addError($error, $i, 'Indent', $data);
        ...
        /* we allow some parameters in same line.
