...
if (class_exists('Windwalker_Sniffs_Commenting_FileCommentSniff', true) === false) {
    $error = 'Class Windwalker_Sniffs_Commenting_FileCommentSniff not found';
    throw new PHP_CodeSniffer_Exception($error);
}
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Windwalker_Sniffs_Commenting_ClassCommentSniff extends Windwalker_Sniffs_Commenting_FileCommentSniff
{
