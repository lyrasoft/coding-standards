 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Windwalker_Sniffs_Commenting_FunctionCommentSniff implements PHP_CodeSniffer_Sniff
{
    ...
    protected function processParams($commentStart)
    {
        ...
        if (empty($params) === false) {
            ...
            foreach ($params as $param) {
                ...
                // Windwalker change: 3 spaces to make it line up with the @return tag with a 2 space gap.
			...
			// Windwalker modification to 1 spaces.
