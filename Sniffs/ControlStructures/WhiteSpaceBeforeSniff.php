<?php
/**
 * Windwalker_Sniffs_ControlStructures_WhiteSpaceBeforeSniff.
 *
 * PHP version 5
 *
 ...
 * @since      1.0
 */
class Windwalker_Sniffs_ControlStructures_WhiteSpaceBeforeSniff implements PHP_CodeSniffer_Sniff
{
	/**
